 ...
 */
class DomainEntityTimeSheetProxy extends \Domain\Entity\TimeSheet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->_load();
        return parent::getLastStatusChange();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'registrant', 'statusChanges');
    }
